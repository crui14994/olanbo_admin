        ...
        children: [
            {
                ...
                children: [
                    ...
                    { path: 'productEdit/:id', name: 'productEdit', component: () => import('@/pages/operat/product/productEdit'),meta: { title: '产品编辑' }, },
                    { path: 'exampleList', name: 'exampleList', component: () => import('@/pages/operat/examples/exampleList'),meta: { title: '成功案例' }, },
                    { path: 'exampleEdit/:id', name: 'exampleEdit', component: () => import('@/pages/operat/examples/exampleEdit'),meta: { title: '案例编辑' }, },
                    { path: 'solutionList', name: 'solutionList', component: () => import('@/pages/operat/solution/solutionList'),meta: { title: '解决方案' }, },
                    { path: 'solutionEdit/:id', name: 'solutionEdit', component: () => import('@/pages/operat/solution/solutionEdit'),meta: { title: '解决方案编辑' }, },
            ...
            {path: '/orders',name: ' 订单物流管理',component: { render(c) { return c('router-view') } },},
            {path: '/credentials',name: '开发者资质认证',component: { render(c) { return c('router-view') } },},
            {path: '/developers', name: ' 开发者账号管理',component: { render(c) { return c('router-view') } },},
            {path: '/agent',name: '代理商管理',component: { render(c) { return c('router-view') } },},
            {
                path: '/appUpgrade',
                name: 'app升级管理',
